...
template <typename Dtype>
class NeighborhoodUnfoldingLayer : public Layer<Dtype> {
 public:
  explicit NeighborhoodUnfoldingLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "NeighborhoodUnfolding"; }
  virtual inline int ExactNumBottomBlobs() const { return 1; }
  virtual inline int ExactNumTopBlobs() const { return 1; }
 ...
 //     const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom);
  ...
  int neigh_h_, neigh_w_;
  int pad_h_, pad_w_;
  int im_h_, im_w_, channels_, im_unfolded_h_, im_unfolded_w_;
  bool copy_padding_, self_copying_;
};


template <typename Dtype>
class CrossInputNeighborhoodDiffsLayer : public Layer<Dtype> {
 public:
  explicit CrossInputNeighborhoodDiffsLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "CrossInputNeighborhoodDiffs"; }
