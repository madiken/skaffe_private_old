...
class BilinearLayer : public Layer<Dtype>{
 public:
  ...
  virtual inline int ExactNumTopBlobs() const { return 1; }
  virtual inline const char* type() const { return "BilinearLayer"; }
...
/*
template <typename Dtype>
class BilinearPatchLayer : public Layer<Dtype>{
 public:
  explicit BilinearPatchLayer(const LayerParameter& param)
      : Layer<Dtype>(param){}

  virtual ~BilinearPatchLayer(){
        for (int i = 0; i < num_h*num_w; i++){
		delete buffer1_matrix[i];
		delete buffer2_matrix[i];
  ...
  virtual inline int ExactNumBottomBlobs() const { return 2; }
  virtual inline int ExactNumTopBlobs() const { return 1; }
  virtual inline const char* type() const { return "BilinearPatchLayer"; }
 ...
 protected:
  ...
  int patch_h;
  int patch_w;
  vector<Blob<Dtype>*> buffer1_matrix;
  vector<Blob<Dtype>*> buffer2_matrix;

 // Blob<Dtype> buffer1;
 // Blob<Dtype> buffer2;
  Blob<Dtype> buffer3;

  Blob<Dtype> dldx_buffer;
...
template <typename Dtype>
class BilinearPatchFastLayer : public Layer<Dtype>{
 public:
  explicit BilinearPatchFastLayer(const LayerParameter& param)
      : Layer<Dtype>(param){}
  ...
  virtual inline int ExactNumTopBlobs() const { return 1; }
  virtual inline const char* type() const { return "BilinearPatchFastLayer"; }
...
class BilinearPatchLayer : public Layer<Dtype>{
 ...
 protected:
  virtual void Forward_cpu(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);//not implemented
  virtual void Backward_cpu(const vector<Blob<Dtype>*>& top,
      const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom); //not implemented
  virtual void Forward_gpu(const vector<Blob<Dtype>*>& bottom,const vector<Blob<Dtype>*>& top);
  virtual void Backward_gpu(const vector<Blob<Dtype>*>& top, const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom);
...
template <typename Dtype>
class SqrtNormalizationLayer : public Layer<Dtype> {
 public:
  explicit SqrtNormalizationLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "SqrtNormalization"; }
  virtual inline int ExactNumBottomBlobs() const { return 1; }
  virtual inline int ExactNumTopBlobs() const { return 1; }
...
//  virtual void Backward_gpu(const vector<Blob<Dtype>*>& top,
 //     const vector<bool>& propagate_down, const vector<Blob<Dtype>*>& bottom);
  ...
  Blob<Dtype> buffer_;
  Blob<Dtype> shift_buffer_;

};


/**
 * @brief Compute elementwise product of all maps from the first blob and second blob's sole map.
 *
 */
template <typename Dtype>
class EltwiseProdGroupLayer : public Layer<Dtype> {
 public:
  explicit EltwiseProdGroupLayer(const LayerParameter& param)
      : Layer<Dtype>(param) {}
  virtual void LayerSetUp(const vector<Blob<Dtype>*>& bottom,
      const vector<Blob<Dtype>*>& top);
  virtual void Reshape(const vector<Blob<Dtype>*>& bottom,
  ...
  virtual inline const char* type() const { return "EltwiseProdGroup"; }
  virtual inline int ExactNumTopBlobs() const { return 1; }
  virtual inline int ExactNumBottomBlobs() const { return 2; }
